var HOSPITAL_TYPE="1"; //병원 타입 1~11
var HOSPITAL_IMAGE=""; //병원 타입에 따른 이미지
var CURRENT_ADDRES=""; // 페이지 접속시 주소
...
function paramTypeToText(paramType, returnString){
    ...
    if(SEARCH_TYPE==false) {
       ...
       //$(".sidebar-nav-item").css("background", "#0371EA");
       $("#left-menu-h-"+paramType).css("background", "#2FBCDC");
...
function displayCenterInfo(result, status) {
    ...
    var keywordValue=CURRENT_ADDRES+" " +paramSearch;
...
function displayPlaces(places) {
    ...
    //기존 마커이미지 제거
     $(".multi-marker-div").parent("div").parent("div").remove();
        //기존 마커이미지 제거
    $(".multi-marker").parent("div").parent("div").parent("div").remove();
...
function addMarker(position, idx, place) {
   ...
   // console.log(place);
    ...
    var iwContent = '<div style="padding:6px 5px;"> <img src="'+HOSPITAL_IMAGE+'" style="height:23px" class="multi-marker"> ';
...
function displayInfowindow(marker, place) {
    ...
    //http://place.map.kakao.com/8408899
...
//     location.href="?hospital="+hospital;
...
function menuLink(hospital){
    ...
    if(CURRENT_ADDRES_FIX!=null && CURRENT_ADDRES_FIX!=""){
       ...
       $(".sidebar-nav-item").css("background", "#0371EA");
       $("#left-menu-h-"+hospital).css("background", "#2FBCDC");
